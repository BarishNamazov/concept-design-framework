...
const register = defineEndpoint("/auth/register", ({
  Sync,
  Actions,
  Request,
  Respond,
...
const login = defineEndpoint("/auth/login", ({
  Sync,
  Actions,
  Request,
  Respond,
...
const logout = defineEndpoint("/auth/logout", ({
  Sync,
  Actions,
  Request,
  Respond,
...
const me = defineEndpoint("/auth/me", ({
  Sync,
  Actions,
  Request,
  Respond,
...
const changePassword = defineEndpoint("/auth/changePassword", ({
  Sync,
  Actions,
  Request,
  Respond,
