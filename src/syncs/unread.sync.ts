...
const list = defineEndpoint("/unread/list", ({
  Sync,
  Actions,
  Request,
  Respond,
...
const unreadCount = defineEndpoint("/unread/count", ({
  Sync,
  Actions,
  Request,
  Respond,
...
const markSeen = defineEndpoint("/unread/markSeen", ({
  Sync,
  Actions,
  Request,
  Respond,
...
const markAllSeen = defineEndpoint("/unread/markAllSeen", ({
  Sync,
  Actions,
  Request,
  Respond,
